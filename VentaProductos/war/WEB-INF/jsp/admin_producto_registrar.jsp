...
<body>
	<div class="sub_principal">
		...
		<div class="contenido">
			...
			<input class="caja" name="nombre" type="text">
			<div class="label">PRECIO UNITARIO COMPRA</div>
			<input class="caja" name="precio_unitario_compra" type="text">
			<div class="label">PRECIO UNITARIO VENTA</div>
